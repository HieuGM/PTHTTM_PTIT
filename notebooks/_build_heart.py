# -*- coding: utf-8 -*-
"""Build the Heart Disease notebook: create .ipynb from source, execute, save with outputs."""
import nbformat as nbf
from nbclient import NotebookClient
import pathlib

SRC = pathlib.Path(r"C:\Users\Laptop\OneDrive\Laptop\Ki 1 - Nam 4\HTTM\assignment01\notebooks\heart_nb_source.py")
OUT = SRC.with_name("01_heart_disease_system.ipynb")
...
for line in lines:
    if line.startswith("#%% [md]"):
        ...
        if in_md:
            # md blocks are written as python comments: strip one leading '#'
            if line.startswith("#"):
